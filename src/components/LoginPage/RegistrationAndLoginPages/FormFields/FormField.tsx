...
import { commonFieldPropsType, fieldPropertiesType } from "../../LoginPageTypes"

type loginFormFieldPropsType = {
  fieldProperties: fieldPropertiesType | any
...
const FormField: React.FC<loginFormFieldPropsType> = ({
  fieldProperties,
